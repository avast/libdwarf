...
// == Decompiler BEGIN ==
// We have to force the definitions of HAVE_MEMCPY and HAVE_MEMMOVE. Without
// them, MSVC fails with the following linking errors:
//
//   libelf.lib(32.xlatetof.c.obj) : error LNK2001: unresolved external symbol _bcopy
//   libelf.lib(64.xlatetof.c.obj) : error LNK2001: unresolved external symbol _bcopy
//
// This is because when these symbols are not defiend, libelf uses bcopy()
// instead of memcpy() (see the code below in this file).
